...
namespace mx
{
	namespace render
	{
		...
		{
			m_pRenderTarget = pRenderer->GetRenderTargetManager()->CreateRenderTarget(ERTF_COLOR_TEXTURE | ERTF_POSITION_TEXTURE | ERTF_NORMAL_TEXTURE | ERTF_DEPTH_TEXTURE, 8, 8);
		}
