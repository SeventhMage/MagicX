...
namespace mx
{
	...
	public:
		//通过驱动程序选择组件并初始化
		MagicX(IDevice *pDevice, IRenderer *pRenderer, IResourceManager *pResourceMgr, ISceneManager *pSceneMgr);
		~MagicX() {}
	...
	private:
		...
		void SetSceneManager(ISceneManager *pMgr) { m_SceneMgr = pMgr; }
	private:
		IDevice *m_pDevice;
